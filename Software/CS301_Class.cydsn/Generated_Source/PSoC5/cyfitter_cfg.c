...
#define BS_UDB_0_4_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000EBCu)

/* UDB_0_5_1_CONFIG Address: CYDEV_UCFG_B0_P7_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_5_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000F3Cu)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48001004u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AG, 0x84u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_SW0, 0x11u);
...
uint8 CYXDATA * const CYCODE sensorSelector_mux__addrTable[12] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE sensorSelector_mux__maskTable[12] = {
	0x10u, 0x00u, 
	0x20u, 0x20u, 
	0x80u, 0x80u, 
	0x01u, 0x10u, 
...
/*******************************************************************************
* Function Name: sensorSelector_mux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void sensorSelector_mux_Set(uint8 channel)
{
	if (channel < 6)
	{
		channel += channel;
		*sensorSelector_mux__addrTable[channel] |= sensorSelector_mux__maskTable[channel];
		channel++;
		*sensorSelector_mux__addrTable[channel] |= sensorSelector_mux__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: sensorSelector_mux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void sensorSelector_mux_Unset(uint8 channel)
{
	if (channel < 6)
	{
		channel += channel;
		*sensorSelector_mux__addrTable[channel] &= (uint8)~sensorSelector_mux__maskTable[channel];
		channel++;
		*sensorSelector_mux__addrTable[channel] &= (uint8)~sensorSelector_mux__maskTable[channel];
	}
}
