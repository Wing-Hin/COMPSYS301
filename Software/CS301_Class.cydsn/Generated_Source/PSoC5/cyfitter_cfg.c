...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000F88u)

/* PHUB_CFGMEM1 Address: CYREG_PHUB_CFGMEM1_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000F8Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT0_AG, 0x88u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT1_AG, 0xD4u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_SW0, 0x42u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_SW3, 0x20u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR1_SW0, 0x8Du);
...
uint8 CYXDATA * const CYCODE AMux_1__addrTable[12] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_1__maskTable[12] = {
	0x04u, 0x00u, 
	0x20u, 0x00u, 
	0x20u, 0x20u, 
	0x40u, 0x00u, 
